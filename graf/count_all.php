...
(SELECT COUNT(*) FROM kvitancy WHERE date_priemka between '2011-09-01' and '2011-09-31'	) AS cnt_1as,
(SELECT COUNT(*) FROM kvitancy WHERE date_priemka between '2011-10-01' and '2011-10-31'	) AS cnt_1asa2,
(SELECT COUNT(*) FROM kvitancy WHERE date_priemka between '2011-11-01' and '2011-11-31'	) AS cnt_14ed,
(SELECT COUNT(*) FROM kvitancy WHERE date_priemka between '2011-12-01' and '2011-12-31'	) AS cnt_13e2q,
...
for ($i=1; $i<=48; $i++) {
 ...
 $Test->drawTitle(60,22,"Все приемки с 2011 до 2015",50,50,50,585);  
