...
<head>
	<title>
		ФИЛЬТР ЗАЯВОК | Последний коммент
	</title>
...
if ($_SESSION['login'] == $rowc['login']) {
echo  '</b> <font color="#AFD7FF">' . ' ' . $rowc['date'] . ' ' . $rowc['fam'] . ' ' . $rowc['imya'] . ' aka ' . $rowc['login'] . ' пишет: ' . '' . $rowc['comment'] . '</font> ' . '</li><br>' ;
}
else {
