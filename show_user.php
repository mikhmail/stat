...
<head>
	<title>
		ФИЛЬТР ЗАЯВОК | Показать пользователя
	</title>
...
<table align="center" border="1" width="1024">
	...
	<tr>
		...
		<input name="login" value="<?=$rowuser['login']?>" type="text" disabled size="10">
		
		<b>Пароль:</b>
		<input name="password" value="<?=$rowuser['password']?>" type="password" disabled size="10">
		<br>
		<br>
		<b>Фамилия:</b>
		<input name="fam" value="<?=$rowuser['fam']?>" type="text" disabled size="20">

		<b>Имя:</b>
		<input name="imya" value="<?=$rowuser['imya']?>" type="text" disabled size="15">

		<b>Отчество:</b>
		<input name="otch" value="<?=$rowuser['otch']?>" type="text" disabled size="20">
	...
	<tr>
		...
		<b>Номер телефона:</b>
		<input name="phone" value="<?=$rowuser['phone']?>" type="text" disabled size="50"><br>

		<b>E-mail:</b>
		<input name="mail" value="<?=$rowuser['mail']?>" type="text" disabled size="50"><br>
		
		<b>Адрес:</b>
		<input name="adres" value="<?=$rowuser['adres']?>" type="text" disabled size="65">
